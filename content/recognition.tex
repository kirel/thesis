...
Es ist möglich DTW dadurch zu optimieren, dass bei der Suche nach dem optimalen Warping-Pfad nicht die ganze Matrix durchsucht wird. Stattdessen wird der Suchraum beschränkt.
\TODO in der Spracherkennung wird das schon lange gemacht mit dem 10\% Sakoe-Chiba-Band
- Auch Itakura Parallelogramm
- Leichte Geschwindigkeitsverbesserung \( \mathcal{O}(ns) \) für fest gewähltes $s$
- Verhindert pathologisches Warpen \cite{Keogh:2005p7751}
- Lokale Beschränkungen werden in Rabiner and Juang 1993 beschrieben aber an sich sind das auch bloß globale Beschränkungen \cite{Keogh:2005p7751}
- Sakoe and Chiba 1978 haben wohl schon rausgefunden, dass globale beschränkungen helfen \cite{Keogh:2005p7751}

\citet{Ann:2008p7714} zitieren!
...
\cite{Keogh:2005p7751} beschreibt LBmKeogh

\citet{Ann:2008p7714} auch hier!
